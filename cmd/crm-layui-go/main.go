...
import (
	...
	"github.com/lihaicheng/crm-layui-go/internal/crm-layui-go-gin/pkg/logger"
	"github.com/lihaicheng/crm-layui-go/internal/crm-layui-go-gin/server"
...
const (
	defaultConfigFile = "configs/crm-layui-go.conf"
)
...
func main() {
	...
	svcConfig := &svc.Config{
		Name:        "github.com/lihaicheng/crm-layui-go",
		DisplayName: "github.com/lihaicheng/crm-layui-go",
		Description: "github.com/lihaicheng/crm-layui-go",
